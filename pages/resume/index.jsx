    ...
    <div style={{ maxWidth: "750px", margin: "0 auto", fontSize: "small" }}>
      ...
      <div className="row">
        ...
        <div className="col-9">
          ...
          <p>
            With eight years of product and software development experience, I
            bring customer-oriented features to your product. Using my
            incredible drive to quickly learn existing and new technologies.
            Where mastering these technologies is something I love doing!
          </p>
          <p>
            I have hands-on experience with the following technologies &
            languages: Linux, JavaScript, NodeJS, PHP, TypeScript, Perl, Ruby,
            macOS, Docker, NextJS, Laravel, React, React Native, Kubernetes
            (K8S/K3S), Proxmox VE, NestJS, AWS, VueJS, PostgreSQL, MySQL, Git,
            Mercurial, Cordova.
          </p>
          ...
          <ResumeEmploymentHistory
            ...
            technologies={[
              ...
              "Polyglot (PHP, JS/TS, React (TS/JS), MicroUI, Perl, Ruby, Bash)",
              "Design tools (Miro, Jira, Confluence)",
          ...
          >
            ...
            I worked with the product team on new features, wrote technical documentation with great attention to detail,
            and broken them down into manageable tasks for any team to pick them up and start working on the.
          </ResumeEmploymentHistory>
          <ResumeEmploymentHistory
